...
myApp.controller('HomeController', ['$scope', '$timeout', function($scope, $timeout) {
    ...
    $scope.grid_item_message_2 = 'Sign agreement & get our company\'s guaranteed paperwork and pay $8 for tonight.';
    
    $scope.grid_item_title_3 = 'Get your car back';
    $scope.grid_item_message_3 = 'Your car will be parked at assigned space or near your home by 6AM next morning. Key placed insided security sealed envelope in front of your door.';
